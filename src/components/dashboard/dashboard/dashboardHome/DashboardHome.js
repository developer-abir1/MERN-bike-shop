                    ...
                    <h2 className=" py-2 bg-white ">
                        ...
                        <div class="offcanvas offcanvas-start bg-info" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                            ...
                            <ul id="listItem   " class="list-unstyled">
                                <Link to="/dashboard" style={{ textDecoration: "none", color: 'black', display: "flex", alignItems: "center" }} className=" mb-3 px-4">
                                    ...
                                    <li className="fs-4  fw-normal" > Dashboard</li>
                                </Link>
                                <Link className=" mb-3 px-4" to="/dashboard/castomerReview" style={{ textDecoration: "none", color: 'black', display: "flex", alignItems: "center" }}>
                                    <svg style={{ height: "20px" }} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                    </svg>
                                    <li className="fs-4  fw-normal ">Castomer Review</li>
                                </Link>
                                <Link className=" mb-3 px-4" to="/dashboard/payment" style={{ textDecoration: "none", color: 'black', display: "flex", alignItems: "center" }}>
                                    <svg style={{ height: "20px" }} xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                                    </svg>
                                    <li className="fs-4  fw-normal ">Payment</li>
                                </Link>
